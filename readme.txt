...
A handy utility plugin that provides support for media queries and emulating CSS3 pseudo-classes and attribute selectors in Internet Explorer 6-8. Uses [Selectivizr](https://github.com/keithclark/selectivizr) and [Respond.js](https://github.com/scottjehl/Respond).

_Uses conditional statements to only load these libraries in IE8 or older._

== Installation ==

1. Upload the `wp-fossil` folder to the `/wp-content/plugins/` directory
